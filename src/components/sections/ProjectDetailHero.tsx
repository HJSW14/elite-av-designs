...
export function ProjectDetailHero({ slug }: { slug: string }) {
      ...
      <Container className="relative z-10 pt-32 pb-16 lg:pt-40 lg:pb-24">
        ...
        >
          ...
          >
            ...
            <ChevronRight className="h-3 w-3" />
            <span className="text-[#D4844C] line-clamp-1">{project.title}</span>
          </motion.nav>
          ...
          <motion.div
            variants={fadeUp}
            className="mt-6 flex items-center gap-2 text-[13px] text-[#7A7570]"
          >
