    ...
    <section className="noise-overlay relative overflow-hidden bg-[#0C0C0C] pt-32 pb-20 lg:pt-40 lg:pb-28">
      ...
      <Container className="relative z-10">
        ...
        >
          ...
          >
            Projects that{" "}
            <span className="heading-display text-[#D4844C]">speak</span> for
            themselves
          </motion.h1>
          ...
          >
            From intimate theater rooms to sprawling smart estates, browse a
            selection of our recent installations across the Denver metro area.
          </motion.p>
        </motion.div>
      </Container>
